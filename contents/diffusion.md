...
For that purpose create a container (let's say 40x80) and fill
its left half with let's say 150 molecules that are sped by [Brownian
motion](https://en.wikipedia.org/wiki/Brownian_motion). See if the diffusion
