...
In this exercise your job is to write a terminal based application that measures
your (touch) typing speed, like the one presented in the GIF below (it doesn't
have to be exact).

![A terminal based application that measures typing speed.](./images/touchTyping.gif){#fig:touchTyping}

Your program should allow for:
- marking the characters (in)correctly typed
- allow to delete incorrectly typed characters
